...
{
Magenta Systems WMI and SMART Component demo application v5.0
...
begin
    ...
    try
        ...
        rows := MagWmiGetInfo (edtComputer.Text, edtNameSpace.Text, edtUser.Text,
                                  edtPass.Text, edtClass.Text, WmiResults, instances) ;
        if rows > 0 then
        begin
            LabelInstances.Caption := 'Instances: ' + IntToStr (instances) ;
        ...
        LabelInstances.Caption := 'Instances: None' ;  
    finally
